    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 md:px-8 pt-4 md:pt-6 pb-2 md:pb-4 flex items-center justify-between border-b border-black/5">
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <h3 className="font-bold text-[#333333] text-[15px] tracking-tight">Search Results ({filteredResults.length})</h3>
        </div>
        ...
        <div className="flex items-center gap-5">
          <div className="relative flex items-center gap-2" ref={layerRef}>
            ...
            <button 
              ...
              className={`text-[13px] font-bold tracking-tight rounded-lg px-3 py-1.5 flex items-center gap-1 transition-colors ${
                showLayerMenu ? 'bg-[#dce6ff] text-[#333333]' : 'bg-[#eef3ff] text-[#333333] hover:bg-[#dce6ff]'
              }`}
            >
          ...
          <div className="relative flex items-center gap-2" ref={typeRef}>
            ...
            <button 
              ...
              className={`text-[13px] font-bold tracking-tight rounded-lg px-3 py-1.5 flex items-center gap-1 transition-colors ${
                showTypeMenu ? 'bg-[#dce6ff] text-[#333333]' : 'bg-[#eef3ff] text-[#333333] hover:bg-[#dce6ff]'
              }`}
            >
        ...
        {filteredResults.map((item, i) => {
          ...
          return (
            <div 
              ...
              className={`p-2.5 flex items-center justify-between transition-colors cursor-pointer border border-gray-200 rounded-[12px] mb-2 gap-2 ${
                explorerState?.selectedDetail?.id === item.id ? 'bg-white/90 shadow-sm ring-1 ring-gray-300 backdrop-blur-sm' : 'bg-white/60 hover:bg-white/80 hover:shadow-sm backdrop-blur-sm'
              }`}
            >
              ...
              <div className="flex items-center gap-1 shrink-0">
                <button className="text-gray-400 hover:text-[#3D52A0] transition-colors w-6 h-6 flex items-center justify-center">
